...
class TestBase(unittest.TestCase):
    ...
    def test_to_jason_string(self):
        """Test for returning Json rep of list_dictionaries"""
    ...
    def test_from_json_string(self):
        """Test Json represntation that returns string"""
    ...
    def test_save_to_file(self):
        """Test writing Json str representantion to a file"""
        r1 = Rectangle(4, 6)
        r2 = Rectangle(1, 2)
        s1 = Square(5)
        s2 = Square(6)
    ...
    def test_create(self):
        """Test if all attributes of instance are set"""
        dic = {"id": 1}
        obj = Base(**dic)
    ...
    def test_load_from_file(self):
        """Test if list of instances is returned"""
        r1 = Rectangle(4, 6)
        r2 = Rectangle(1, 2)
        s1 = Square(5)
        s2 = Square(6)
    ...
    def test_load_object(self):
        """Test if the objects have been loaded to the file"""
        load_rectangle = Rectangle.load_from_file_csv()
        load_square = Square.load_from_file_csv()
